        ...
        <div class="row box">
            ...
            <?php } ?>
                <div  class="col-xs-12 col-sm-12  col-md-6 col-md-6 col-md-offset-3 formbox text-center">
                    ...
                    <form action="index.php?action=addComment&amp;<?php if(isset($post)){?>id=<?= $post->id()?> <?php }?>" method="post">
